                ...
                >
                  ...
                  <div className="model-icon-wrapper">
                    <div
                      ...
                      style={model.icon.startsWith('http') || model.icon.startsWith('/') ? { padding: 0, overflow: 'hidden', borderRadius: '6px' } : { fontSize: '18px' }}
                    >
                      {model.icon.startsWith('http') || model.icon.startsWith('/') ? (<img src={model.icon} alt={model.name} loading="lazy" decoding="async" className="w-5 h-5 object-cover rounded" />) : (model.icon)}
                    </div>
                  </div>
