  ...
  providers: [
    ...
    },
    {
      ...
      models: [
        ...
        { localModel: 'seedance-2', upstreamModel: 'bytedance/seedance-2-mini/video', category: 'video', enabled: true },
        { localModel: 'gemini-omni', upstreamModel: 'gemini-omni/video', category: 'video', enabled: true },
        { localModel: 'happyhorse', upstreamModel: 'happyhorse-1.1/video', category: 'video', enabled: true },
        { localModel: 'wan-2-7-video', upstreamModel: 'wan-2.7-video/video', category: 'video', enabled: true },
      ],
    },
  ],
};
...
const KIE_MODEL_MAPPING: Record<string, { upstreamModel: string; category: ProviderCategory }> = {
  ...
  'seedance-2-5': { upstreamModel: 'bytedance/seedance-2.5/video', category: 'video' },
  'happyhorse-1-0': { upstreamModel: 'happyhorse-1.0/video', category: 'video' },
  'happyhorse-1-1': { upstreamModel: 'happyhorse-1.1/video', category: 'video' },
  'omnihuman-1-5': { upstreamModel: 'omnihuman-1.5/video', category: 'video' },
  'seedance-1-0-pro-fast': { upstreamModel: 'bytedance/seedance-1.0-pro-fast/video', category: 'video' },
  'seedance-1-5-pro': { upstreamModel: 'bytedance/seedance-1.5-pro/video', category: 'video' },
  'seedance-2-0': { upstreamModel: 'bytedance/seedance-2.0/video', category: 'video' },
  'seedance-2-0-mini': { upstreamModel: 'bytedance/seedance-2.0-mini/video', category: 'video' },
  ...
  'kling-3-motion-control': { upstreamModel: 'kling-3.0-motion-control/video', category: 'video' },
  ...
  'wan-2-5': { upstreamModel: 'wan-2.5/video', category: 'video' },
  'wan-2-6': { upstreamModel: 'wan-2.6/video', category: 'video' },
  'wan-2-7-video': { upstreamModel: 'wan-2.7-video/video', category: 'video' },
  'wan-v2-2': { upstreamModel: 'wan-2.2-a14b/video', category: 'video' },
  'grok-imagine': { upstreamModel: 'grok-imagine/video', category: 'video' },
  'grok-imagine-video-1.5': { upstreamModel: 'grok-imagine-video-1.5/video', category: 'video' },
  // Audio
